    ...
    render() {
        return (
                <div className="col-lg-12 col-xs-12 col-md-12">
                    <h2>FluxZ-YARSK</h2>
                    <p>This is a simple (non isomorphic) starter kit using React, Flux(Alt), Bootstrap and React Router.  The project's build system uses Gulp, Webpack, Babel</p>
                    <p>This project aims to create a simple REACT + Flux starter kit to quickly jump start your app.  It includes sample components and pattern demonstrations common use cases.</p>
